...
public class PullToRefreshLayout extends RelativeLayout {
  ...
  private AnimationDrawable refreshingFrameAnim;
  ...
  private void initView(Context context, AttributeSet attrs, int defStyle) {
    ...
    reverseUpAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
        context, R.anim.anim_reverse_up);
    reverseDownAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
        context, R.anim.anim_reverse_down);
    refreshingAnimation = (RotateAnimation) AnimationUtils.loadAnimation(
        context, R.anim.anim_rotating);

    refreshingFrameAnim = new AnimationDrawable();
    refreshingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_refreshing_one), 50);
    refreshingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_refreshing_two), 50);
    refreshingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_refreshing_three), 50);
    refreshingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_refreshing_four), 50);
    refreshingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_refreshing_five), 50);
    refreshingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_refreshing_six), 50);
    refreshingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_refreshing_seven), 50);
    refreshingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_refreshing_eight), 50);

    loadingFrameAnim = new AnimationDrawable();
    loadingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_loading_one), 50);
    loadingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_loading_two), 50);
    loadingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_loading_three), 50);
    loadingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_loading_four), 50);
    loadingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_loading_five), 50);
    loadingFrameAnim.addFrame(getResources().getDrawable(R.drawable.icon_loading_six), 50);
    ...
    defaultRefreshView = inflater.inflate(R.layout.view_refresh_head, this, false);
    mRlHeadView = defaultRefreshView.findViewById(R.id.rl_head_view);
    refreshView = defaultRefreshView;
    defaultLoadmoreView = inflater.inflate(R.layout.view_refresh_load_more, this, false);
   ...
   * 设置自定义下拉头
   */
  public void setChangeDefaultRefreshView(View v) {
    removeView(defaultRefreshView);
    defaultRefreshView = v;
    addView(defaultRefreshView);
    refreshView = defaultRefreshView;
  }
  ...
  public void refreshFinish(final int refreshResult) {
    new Handler().postDelayed(() -> {
      ...
      if (null == customRefreshView && null != refreshingView) {
        refreshingView.clearAnimation();
        refreshingFrameAnim.stop();
        refreshingView.setVisibility(View.GONE);
      }
      switch (refreshResult) {
        case SUCCEED:
          // 刷新成功
          if (null == customRefreshView && null != refreshStateImageView) {
            refreshStateImageView.setVisibility(View.VISIBLE);
            refreshStateTextView.setText(R.string.tv_refresh_succeed_refreshing);
            refreshStateImageView
                .setBackgroundResource(R.mipmap.icon_refresh_load_succeed);
          }
          break;
        case FAIL:
        default:
          ...
          if (null == customRefreshView) {
            refreshStateImageView.setVisibility(View.VISIBLE);
            refreshStateTextView.setText(R.string.tv_refresh_failed_refreshing);
            refreshStateImageView
                .setBackgroundResource(R.mipmap.icon_refresh_load_failed);
          }
          break;
      }
      if (pullDownY > 0) {
    ...
    switch (refreshResult) {
      case SUCCEED:
        ...
        if (null == customLoadmoreView) {
          ...
          loadStateTextView.setText(R.string.tv_refresh_succeed_loading);
          loadStateImageView
              .setBackgroundResource(R.mipmap.icon_refresh_load_succeed);
        }
        break;
      ...
      default:
        ...
        if (null == customLoadmoreView) {
          loadStateImageView.setVisibility(View.VISIBLE);
          loadStateTextView.setText(R.string.tv_refresh_failed_loading);
          loadStateImageView
              .setBackgroundResource(R.mipmap.icon_refresh_load_failed);
        }
        break;
  ...
  private void changeState(int to) {
    ...
    switch (state) {
      case INIT:
        ...
        if (null == customRefreshView) {
          ...
          if(refreshStateTextView!=null){
            refreshStateTextView.setText(R.string.tv_refresh_pull_refreshing);
          }
        ...
        if (null == customLoadmoreView) {
          ...
          loadStateImageView.setVisibility(View.GONE);
          loadStateTextView.setText(R.string.tv_refresh_pull_loading);
      ...
      case RELEASE_TO_REFRESH:
        ...
        if (null == customRefreshView) {
          if(refreshStateTextView!=null){
            refreshStateTextView.setText(R.string.tv_refresh_release_refreshing);
            refreshStateImageView.setVisibility(View.GONE);
          }
      ...
      case REFRESHING:
        ...
        if (null == customRefreshView
            && null != pullDownView
            && null != refreshingView
            && null != refreshStateTextView) {
          refreshStateImageView.setVisibility(View.GONE);
          pullDownView.clearAnimation();
          refreshingView.setVisibility(View.VISIBLE);
          pullDownView.setVisibility(View.INVISIBLE);
          refreshingFrameAnim.start();
          //                    refreshingView.startAnimation(refreshingAnimation);
          refreshStateTextView.setText(R.string.tv_refresh_refreshing);
        }
        break;
      case RELEASE_TO_LOAD:
        ...
        // 释放加载状态
        if (null == customLoadmoreView) {
          loadStateTextView.setText(R.string.tv_refresh_release_loading);
      ...
      case LOADING:
        ...
        if (null == customLoadmoreView) {
          ...
          loadingFrameAnim.start();
          loadStateTextView.setText(R.string.tv_refresh_loading);
        } else {
  ...
  public boolean dispatchTouchEvent(MotionEvent ev) {
    switch (ev.getActionMasked()) {
      ...
      case MotionEvent.ACTION_MOVE:
        ...
        if (mEvents == 0) {
          if (pullDownY > 100 || pullableView != null && (((Pullable) pullableView).canPullDown() && mCanPullDown &&
              mPullDownEnable && state != LOADING)) {
            // 可以下拉，正在加载时不能下拉
            // 对实际滑动距离做缩小，造成用力拉的感觉
  ...
  private void initView() {
    ...
    if (null == customRefreshView) {
      ...
      refreshingView.setBackground(refreshingFrameAnim);
    ...
    if (null == customLoadmoreView) {
      ...
      loadingView.setBackground(loadingFrameAnim);
